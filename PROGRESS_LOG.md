...
- التاريخ: 2026-07-09 · الأساس: `origin/main@b610336` (Phase 17 مدموجة قبل البدء ✅)
...
- **الفحوصات:** ‏lint ✅ · tsc ✅ · build ✅ (`/hotel/subscription` في الشجرة) · الجرس سليم · المسارات تستجيب خلف بوابة الجلسة · القواميس الثلاث متكافئة.
