...
- **الفحوصات:** ‏lint ✅ · tsc ✅ · build ✅ · تحقق هيكلي **بجلسة مصادَقة** (تسجيل دخول فعلي → صفحة `/platform` ترسم البطاقات الثلاث) · الـ CSS المترجم المقدَّم يحمل قواعد البطاقات (shell-gap/radius للثلاثة) — والمعاينة البصرية النهائية متاحة للمالك على الخوادم المحلية.
