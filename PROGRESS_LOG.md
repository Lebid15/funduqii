...
- **الفحوصات:** ‏lint ✅ · tsc ✅ · build ✅ · تحقق هيكلي **بجلسة مصادَقة** (‏`/platform` و`/hotel/rooms` ‏200 بالبنية الثلاثية) · الـ CSS المترجم المقدَّم يحمل قواعد البطاقات **والإصلاحات الثلاثة** (‏max-width:none، إخفاء scrollbar، الحشوة الجديدة) — والمعاينة البصرية النهائية متاحة للمالك على الخوادم المحلية.
