...
- **الفحوصات:** ‏lint ✅ · tsc ✅ · build ✅ · تحقق **بجلسة مصادَقة** على `/hotel/rooms`: البنية الثلاثية + `lang-menu` + زر الخروج `dangerSoft` + بقاء زر القائمة + زوال المبدّل القديم — كلها في الـ HTML المقدَّم؛ والمعاينة البصرية النهائية متاحة للمالك على الخوادم المحلية.
