...
- الحالة: **بانتظار الاعتماد 🔎** (جولة إغلاق متوسطة→كبيرة — ليست مرحلة)
- التاريخ: 2026-07-11 · الأساس: `origin/main@cfc7d85` · الفرع: `claude/restaurant-cafe-final-closure` · منفذة بأمر المالك بعد اعتماد البحث المرجعي والـ Audit والخطة (بقراريها النهائيين: لا مساس بفوليو مغلق إطلاقًا — تصحيحات الدفع المباشر تؤجل للمالية، وإبقاء `source`/`item_type` قديمين مهجورين بلا حذف)
