...
- الحالة: **بانتظار الاعتماد 🔎** (جولة إغلاق أساسية متوسطة — ليست مرحلة)
- التاريخ: 2026-07-11 · الأساس: `origin/main@2e48ba3` · الفرع: `claude/folio-final-closure` · منفذة بأمر المالك بعد اعتماد البحث المرجعي وتقرير الـ Audit وخطة الإغلاق (بقراراتها الـ 16 + البند الاختياري B15 + حارس Reservation Folio)
