...
- التاريخ: 2026-07-11 · الأساس: `origin/main@f05842d` · الفرع: `claude/staff-final-closure` · منفذة بأمر المالك بعد اعتماد البحث المرجعي والـ Audit والخطة (بقراراتها الـ 17) — **صفر Migrations**، والبنية القائمة (User/HotelMembership/HotelPermissionGrant) مصدر الحقيقة بلا أي إعادة بناء.
