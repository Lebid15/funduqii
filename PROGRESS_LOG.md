...
- التاريخ: 2026-07-11 · الأساس: `origin/main@308d821` · الفرع: `claude/expenses-final-closure` · منفذة بأمر المالك بعد اعتماد البحث المرجعي والـ Audit والخطة (بقراراتها الـ 12 + تثبيت تسجيل التعديلات الوصفية بالقيم القديمة والجديدة)
